<template>
  ...
  >
    ...
    <el-menu-item index="/manage/home">
      <i class="el-icon-a-011" style="font-size: 24px;color: white;"></i><span slot="title">主页</span>
    </el-menu-item>
    <el-menu-item index="/">
      <i class="el-icon-a-02" style="font-size: 24px;color: white;"></i><span slot="title">前台</span>
    </el-menu-item>

    <el-submenu index="2">
      <template slot="title" >
        <i class="el-icon-a-031" style="font-size: 24px;color: white;"></i><span slot="title">系统管理</span></template>
      <el-submenu v-show="userGroup" index="user" >
        <template slot="title" ><i class="el-icon-a-01" style="font-size: 24px;color: white;"></i>用户</template>
        <el-menu-item index="/manage/user" v-if="menuFlags.userMenu"> 用户管理</el-menu-item>
      </el-submenu>
      <el-submenu v-if="fileGroup" index="file">
        <template slot="title"><i class="el-icon-a-061" style="font-size: 24px;color: white;"></i>文件</template>
      ...
      <el-submenu v-if="GoodGroup" index="good">
        <template slot="title"><i class="el-icon-a-042" style="font-size: 24px;color: white;"></i>商品</template>
      ...
      <el-submenu v-if="incomeGroup" index="income">
        <template slot="title"><i class="el-icon-a-021" style="font-size: 24px;color: white;"></i>营收</template>
